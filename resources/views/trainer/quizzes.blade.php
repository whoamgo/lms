    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addQuizForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="quizTitle" required class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Description</label>
                        <textarea name="description" id="quizDescription" rows="3" class="form-control"></textarea>
                    </div>
                    <div class="form-group">
                        <label>Quiz Type*</label>
                        <select name="quiz_type" id="quizType" required class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <select name="course_id" id="quizCourse" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="time_limit" id="quizTimeLimit" min="1" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Status*</label>
                        <select name="status" id="quizStatus" required class="form-control">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="addQuizForm" class="btn btn-primary" id="quizSubmitBtn">Add Quiz</button>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="modal-body">
                <form id="addQuestionForm">
                    ...
                    <div class="form-group">
                        ...
                        <select id="questionQuizType" required class="form-control">
                            <option value="">--Select Quiz Type--</option>
                            <option value="practice">Practice</option>
                            <option value="assessment">Assessment</option>
                            <option value="exam">Exam</option>
                    ...
                    <div class="form-group">
                        ...
                        <select id="questionCourseType" required class="form-control">
                            <option value="">--Select Course Type--</option>
                            @foreach(Auth::user()->assignedCourses()->get() as $course)
                                <option value="{{ $course->id }}">{{ $course->title }}</option>
                            @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="question" id="questionText" rows="4" required placeholder="Enter your question..." class="form-control"></textarea>
                    </div>
                    <div id="answersContainer">
                        <div class="answer-row" data-index="0">
                            <div class="answer-item">
                                <input type="radio" name="correct_answer" value="0" required class="answer-radio">
                                <input type="text" name="options[]" class="form-control answer-input" placeholder="Answer 1" required>
                        ...
                        <div class="answer-row" data-index="1">
                            <div class="answer-item">
                                ...
                                <input type="text" name="options[]" class="form-control answer-input" placeholder="Answer 2" required>
                                <button type="button" class="answer-delete-btn" onclick="removeAnswer(this)">
                                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" style="width: 18px; height: 18px;">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                                    </svg>
                        ...
                        <div class="answer-row" data-index="2">
                            <div class="answer-item">
                                ...
                                <input type="text" name="options[]" class="form-control answer-input" placeholder="Answer 3" required>
                                <button type="button" class="answer-delete-btn" onclick="removeAnswer(this)">
                                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" style="width: 18px; height: 18px;">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                                    </svg>
                    ...
                    <p class="text-muted" style="font-size: 0.875rem; margin-bottom: 24px;">Select one correct answer by clicking radio button</p>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-dark" data-bs-dismiss="modal">Cancel</button>
...
<div class="modal fade" id="viewQuestionsModal" tabindex="-1" aria-labelledby="viewQuestionsModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="viewQuestionsModalLabel">Quiz Questions</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
