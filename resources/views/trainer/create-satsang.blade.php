...
<div class="card">
    <h2 style="display: flex; align-items: center; gap: 8px; margin-bottom: 32px;">
        ...
        Schedule Career Satsang
    </h2>
    
    <form id="satsangForm" method="POST" action="{{ route('trainer.satsangs.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div style="border: 1px solid #e5e5e6; border-radius: 8px; padding: 24px; margin-bottom: 24px;">
            ...
            <div class="form-group">
                ...
                <input type="text" name="title" id="satsangTitle" required placeholder="Enter video title">
            </div>
            
            <div class="form-group">
                <label>Description</label>
                <textarea name="description" id="satsangDescription" rows="4" placeholder="Add brief description of your video"></textarea>
            </div>
        </div>
        ...
        <div style="border: 1px solid #e5e5e6; border-radius: 8px; padding: 24px; margin-bottom: 24px;">
            ...
            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px;">
                <div class="form-group">
                    ...
                    <div style="position: relative;">
                        <input type="date" name="scheduled_at" id="satsangDate" required style="padding-right: 40px;">
                ...
                <div class="form-group">
                    ...
                    <div style="position: relative;">
                        ...
                        <input type="time" name="time" id="satsangTime" required style="padding-left: 40px;">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div style="position: relative;">
                        <select name="timezone" id="satsangTimezone" required style="padding-right: 40px; appearance: none;">
            ...
            <div class="form-group" style="margin-top: 20px;">
                ...
                <input type="url" name="meeting_link" id="satsangMeetingLink" placeholder="https://meet.google.com/...">
            </div>
        </div>
        ...
        <div style="border: 1px solid #e5e5e6; border-radius: 8px; padding: 24px; margin-bottom: 24px;">
            ...
            <div class="form-group">
                ...
                <div style="border: 2px dashed #e5e5e6; border-radius: 8px; padding: 40px; text-align: center; background: #f9fafb; cursor: pointer; position: relative;" onclick="document.getElementById('satsangThumbnail').click()">
                ...
                <input type="file" name="thumbnail" id="satsangThumbnail" accept="image/*" style="display: none;" onchange="handleSatsangThumbnailUpload(this)">
                <div style="margin-top: 12px;">
                    <button type="button" onclick="document.getElementById('satsangThumbnail').click()" class="btn" style="background: #f3f4f6; color: #343541; border: 1px solid #e5e5e6;">Browse...</button>
                    <span id="satsangFileStatus" style="margin-left: 12px; color: #6b7280; font-size: 0.875rem;">No file selected.</span>
                </div>
                <div id="satsangThumbnailPreview" style="margin-top: 12px;"></div>
            </div>
        </div>
        
        <div style="border: 1px solid #e5e5e6; border-radius: 8px; padding: 24px; margin-bottom: 24px;">
            <label style="display: flex; align-items: center; gap: 12px; cursor: pointer;">
                <input type="checkbox" name="create_playlist" id="satsangCreatePlaylist" style="width: 18px; height: 18px; cursor: pointer;">
