...
@section('breadcrumbs')
    <a href="{{ route('trainer.dashboard') }}">Home</a> / <a href="{{ route('trainer.live-classes') }}">Upcoming Live Classes</a> / Edit
@endsection
...
<div class="card">
    <h2>Edit Live Class</h2>
        ...
        <form method="POST" action="{{ route('trainer.live-classes.update', \App\Helpers\EncryptionHelper::encryptIdForUrl($liveClass->id)) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div style="display: flex; gap: 12px; margin-top: 24px;">
            ...
            <a href="{{ route('trainer.live-classes') }}" class="btn" style="background: #f3f4f6; color: #343541;">Cancel</a>
        </div>
    </form>
</div>
