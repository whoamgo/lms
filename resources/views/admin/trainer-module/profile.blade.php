...
@section('content')
<div class="card">
    <h2 style="font-size: 1.5rem; font-weight: 600; margin-bottom: 24px;">My Profile</h2>
    
    <form method="POST" action="{{ route('admin.trainer-module.update-profile') }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div style="display: flex; gap: 12px;">
            ...
            <a href="{{ route('admin.trainer-module.dashboard') }}" class="btn" style="background: #f3f4f6; color: #343541;">Cancel</a>
        </div>
    </form>
</div>
