...
<?php $__env->startSection('breadcrumbs'); ?>
    <a href="<?php echo e(route('student.dashboard')); ?>">Home</a> / My Profile
...
<div class="profile-sections">
            ...
            <div class="profile-avatar-upload">
                <div class="profile-avatar-large">
                    <?php if($student->avatar): ?>
                        <img src="<?php echo e(asset('storage/' . $student->avatar)); ?>" alt="Avatar">
                    <?php else: ?>
    ...
    <div>
        <form action="<?php echo e(route('student.profile.update')); ?>" method="POST" enctype="multipart/form-data" id="profileForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="profile-section-card">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="nick_name" value="<?php echo e(old('nick_name', $student->nick_name ?? '')); ?>">
                    </div>
                    <div class="form-group">
                        <label>Role</label>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="display_name" value="<?php echo e(old('display_name', $student->display_name ?? $student->name)); ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="profile-section-card">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="email" name="email" value="<?php echo e(old('email', $student->email)); ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Whatsapp</label>
                        <input type="text" name="whatsapp" value="<?php echo e(old('whatsapp', $student->whatsapp ?? '')); ?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label>Website</label>
                        <input type="url" name="website" value="<?php echo e(old('website', $student->website ?? '')); ?>">
                    </div>
                    <div class="form-group">
                        <label>Insta / Telegram</label>
                        <input type="text" name="instagram_telegram" value="<?php echo e(old('instagram_telegram', $student->instagram_telegram ?? '')); ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="profile-section-card">
                ...
                <div class="form-group">
                    ...
                    <textarea name="bio" rows="6" placeholder="Tell us about yourself..."><?php echo e(old('bio', $student->bio ?? '')); ?></textarea>
                </div>
            </div>
...
<?php echo $__env->make('layouts.student', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/ok/resources/views/student/profile.blade.php ENDPATH**/ ?>