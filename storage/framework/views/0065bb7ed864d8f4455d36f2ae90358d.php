...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Student Dashboard'); ?> - LMS</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-menu">
            <li><a href="<?php echo e(route('student.dashboard')); ?>" class="<?php echo e(request()->routeIs('student.dashboard') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                Dashboard
            </a></li>
            <li><a href="<?php echo e(route('student.profile')); ?>" class="<?php echo e(request()->routeIs('student.profile*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                My Profile
            </a></li>
            <li><a href="<?php echo e(route('student.enroll-courses')); ?>" class="<?php echo e(request()->routeIs('student.enroll-courses*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                Enroll Courses
            </a></li>
            <li><a href="<?php echo e(route('student.certificates')); ?>" class="<?php echo e(request()->routeIs('student.certificates*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                My Certificate
            </a></li>
            <li style="display: none;"><a href="<?php echo e(route('student.attendance')); ?>" class="<?php echo e(request()->routeIs('student.attendance*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                Attendance record
            </a></li>
            <li><a href="<?php echo e(route('student.recorded-courses')); ?>" class="<?php echo e(request()->routeIs('student.recorded-courses*') ? 'active' : ''); ?>">
        ...
        <ul class="sidebar-menu">
            <li><a href="<?php echo e(route('student.logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path></svg>
                Logout
            </a></li>
            <li style="display:none;"><a href="<?php echo e(route('student.support')); ?>">
        ...
        <!-- <div class="sidebar-notifications">
            ...
            <a href="<?php echo e(route('student.notifications.index')); ?>" class="btn btn-sm btn-primary sidebar-view-all-btn">View All</a>
        </div>
        
        <form id="logout-form" action="<?php echo e(route('student.logout')); ?>" method="POST" class="hidden-form">
            <?php echo csrf_field(); ?>
        </form>-->
    </div> 
        ...
        <div class="header">
            <div class="d-flex align-items-center">
                ...
                <div class="breadcrumbs">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('student.dashboard')); ?>">Home</a>
                    <?php endif; ?>
                </div>
            </div>
                ...
                <div class="notification-icon-wrapper position-relative">
                    ...
                    <div class="notification-dropdown" id="notificationDropdown">
                        ...
                        <div class="notification-dropdown-footer">
                            <a href="<?php echo e(route('student.notifications.index')); ?>" class="btn btn-sm btn-primary">View All Notifications</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    const NotificationsUnreadCount = '<?php echo e(route("student.notifications.unread-count")); ?>';
    const NotificationsRecent = '<?php echo e(route("student.notifications.recent")); ?>';
    
    const NotificationsMarkAllRead = '<?php echo e(route("student.notifications.mark-all-read")); ?>';
...
<?php /**PATH /var/www/html/ok/resources/views/layouts/student.blade.php ENDPATH**/ ?>