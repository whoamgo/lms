<?php $__env->startSection('title', 'Active Courses Count'); ?>

<?php $__env->startSection('breadcrumbs'); ?>
    <a href="<?php echo e(route('admin.dashboard')); ?>">Home</a> / Active Courses Count
...
<div class="card">
    <div class="card-header-actions">
        ...
        <div class="export-form-container">
            <form method="GET" action="<?php echo e(route('admin.courses.export')); ?>" id="exportForm" class="inline-form">
                <div class="export-form-container">
            ...
            <a href="<?php echo e(route('admin.courses.create')); ?>" class="btn btn-primary">Create New Course</a>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="course-info-cell">
                            <?php if($course->thumbnail): ?>
                                <img src="<?php echo e(asset('storage/' . $course->thumbnail)); ?>" alt="<?php echo e($course->title); ?>" class="course-thumbnail-small">
                            <?php else: ?>
                            ...
                            <?php endif; ?>
                            <div>
                                <div class="course-title-cell"><?php echo e($course->title); ?></div>
                                <div class="course-meta-cell">
                                    <?php if($course->batches->where('status', 'active')->count() > 0): ?>
                                        Active: <?php echo e($course->batches->where('status', 'active')->first()->name); ?>
                    ...
                    <td>
                        <div class="trainers-list-cell">
                            <?php $__empty_1 = true; $__currentLoopData = $course->trainers->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trainer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <span class="trainer-badge-small"><?php echo e($trainer->name); ?></span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <span class="text-muted">No Trainers</span>
                            <?php endif; ?>
                            <?php if($course->trainers->count() > 2): ?>
                                <span class="trainer-badge-more">+<?php echo e($course->trainers->count() - 2); ?></span>
                            <?php endif; ?>
                        </div>
                    </td>
                    <td>
                        <span class="badge badge-info"><?php echo e($course->batches_count); ?> Batches</span>
                        <div class="text-muted-small"><?php echo e($course->batches->where('status', 'active')->count()); ?> Active</div>
                    </td>
                    <td>
                        <span class="badge badge-success"><?php echo e($course->enrollments_count); ?> Students</span>
                    </td>
                    <td>
                        <span class="badge badge-info"><?php echo e($course->videos_count); ?> Videos</span>
                    </td>
                    <td>
                        <form method="POST" action="<?php echo e(route('admin.courses.toggle-status', $course->id)); ?>" class="inline-form">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                            <label class="toggle-switch">
                                <input type="checkbox" <?php echo e($course->status === 'active' ? 'checked' : ''); ?> onchange="this.form.submit()">
                    ...
                    <td>
                        <div class="date-cell">
                            <div><?php echo e($course->start_date ? $course->start_date->format('d M Y') : 'N/A'); ?></div>
                            <div class="text-muted-small"><?php echo e($course->end_date ? $course->end_date->format('d M Y') : 'N/A'); ?></div>
                        </div>
                    </td>
                    <td>
                        <div class="action-buttons">
                            <button class="btn-action btn-view" onclick="viewCourseDetails(<?php echo e($course->id); ?>)" title="View Details">
                                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                </svg>
                            </button>
                            <button class="btn-action btn-delete" onclick="confirmDeleteCourse(<?php echo e($course->id); ?>, '<?php echo e($course->title); ?>')" title="Delete">
                                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function viewCourseDetails(courseId) {
    ...
    fetch(`<?php echo e(url('admin/courses')); ?>/${courseId}/details`, {
        headers: {
...
function confirmDeleteCourse(courseId, courseName) {
    ...
    document.getElementById('deleteCourseForm').action = `<?php echo e(url('admin/courses')); ?>/${courseId}`;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/ok/resources/views/admin/courses/index.blade.php ENDPATH**/ ?>