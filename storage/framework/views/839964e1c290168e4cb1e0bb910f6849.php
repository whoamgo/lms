...
<?php $__env->startSection('breadcrumbs'); ?>
    <a href="<?php echo e(route('admin.dashboard')); ?>">Home</a> / Dashboard
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
<br /><br />
    <div class="stats-grid">
        <a href="<?php echo e(route('admin.student-enroll.index')); ?>" class="stat-card stat-card-link">
            ...
            <div class="content">
                ...
                <div class="value"><?php echo e($totalStudents); ?></div>
            </div>
        </a>
        
        <a href="<?php echo e(route('admin.courses.index')); ?>" class="stat-card stat-card-link">
            <div class="icon blue">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" class="stat-icon">
            ...
            <div class="content">
                ...
                <div class="value"><?php echo e($activeCourses); ?></div>
            </div>
        </a>
        ...
        <a href="<?php echo e(route('admin.student-enroll.index')); ?>" class="stat-card stat-card-link">
            ...
            <div class="content">
                ...
                <div class="value"><?php echo e($totalEnrollments); ?></div>
            </div>
        </a>
        
        <a href="<?php echo e(route('admin.instructors.index')); ?>" class="stat-card stat-card-link">
            <div class="icon blue">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" class="stat-icon">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/>
                </svg>
            ...
            <div class="content">
                ...
                <div class="value"><?php echo e($totalTrainers); ?></div>
            </div>
        </a>
        
        <a href="<?php echo e(route('admin.community-queries.index')); ?>" class="stat-card stat-card-link">
            <div class="icon yellow">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" class="stat-icon">
            ...
            <div class="content">
                ...
                <div class="value"><?php echo e($pendingQueries); ?></div>
            </div>
        </a>
    </div>
    ...
    <div class="card">
        ...
        <div class="quick-actions-container">
            <a href="<?php echo e(route('admin.courses.create')); ?>" class="btn btn-primary">Create Course</a>
            <a href="<?php echo e(route('admin.assign-course.index')); ?>" class="btn btn-primary">Assign Trainer</a>
            <a href="<?php echo e(route('admin.student-enroll.index')); ?>" class="btn btn-primary">View Enrollments</a>
            <a href="<?php echo e(route('admin.community-queries.index')); ?>" class="btn btn-primary">Manage Queries</a>
        </div>
    </div>
                ...
                <?php $__currentLoopData = $recentCourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="recent-course-item">
                        ...
                        <div class="recent-course-content">
                            <h3 class="recent-course-title"><?php echo e($course->title); ?></h3>
                        ...
                        <div class="recent-course-actions">
                            <select class="trainer-select" data-course-id="<?php echo e($course->id); ?>" onchange="assignTrainer(this, <?php echo e($course->id); ?>)">
                                ...
                                <?php $__currentLoopData = $allTrainers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trainer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(!in_array($trainer->id, $assignedTrainerIds)): ?>
...
function assignTrainer(selectElement, courseId) {
    ...
    fetch(`<?php echo e(url('admin/assign-course')); ?>/${courseId}/assign-trainer`, {
        method: 'POST',
        headers: {
...
function executeRemoveTrainer() {
    ...
    fetch(`<?php echo e(url('admin/assign-course')); ?>/${courseId}/remove-trainer/${trainerId}`, {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
            'Content-Type': 'application/json',
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/ok/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>